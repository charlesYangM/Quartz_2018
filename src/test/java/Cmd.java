...
//        uploadWorkerJar();
    ...
    private static void runBatForDaemon() throws Exception {
        builder.command(
                "cmd.exe", "/c", "d: & cd \"D:\\Charles_863_V2_2016-3-28\\autosolve-worker\\bin\""+
                        "& daemon.bat"
                        );
        ExcuteCmd(builder);
    }
    ...
    private static void CopyFileOfWorkerJar() throws Exception {
        System.out.println("cd \"E:\\测试文档_YMX\\autosolve-kafka-worker\\src\\main\\resources\"");
        builder.command(
